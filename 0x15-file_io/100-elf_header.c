...
/**
 * check_elf - check if a file is an file.
 ...
 * @e_ident : A pointer to an aray containing the ELF magic  numbers
 ...
 * Description: if the file can't be close - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
